...
function ComputePERK_Multi_ButcherTableau(NumMethods::Int, NumStages::Int, BasePathMonCoeffs::AbstractString, 
...
mutable struct PERK_Multi{StageCallbacks}
  ...
  function PERK_Multi(NumStageEvalsMin_::Int, NumMethods_::Int,
    ...
    newPERK_Multi.HighestActiveLevels, newPERK_Multi.HighestEvalLevels = 
      ComputePERK_Multi_ButcherTableau(NumMethods_, newPERK_Multi.NumStages, BasePathMonCoeffs_, bS_, cEnd_)
