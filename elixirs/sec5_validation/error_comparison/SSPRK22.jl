...
# CFL_Stab = 1.0 corresponds to maximum timestep that can be taken by the S12 method
# CFL = 0.1 is required for SSPRK22
CFL_Stab = 0.1
...
cd(@__DIR__)
ode_algorithm = SSPRK22(thread = OrdinaryDiffEq.True())
